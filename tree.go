...
// given path.
func (n *node) getValue(path string, ctx *fasthttp.RequestCtx) (handle Handle, tsr bool) {
...
// was successful.
func (n *node) findCaseInsensitivePath(path string, fixTrailingSlash bool) (fixedPath []byte, found bool) {
